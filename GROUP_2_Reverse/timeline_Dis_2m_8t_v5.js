...
const trial8 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">NIGHTMARE</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "NIGHTMARE"},
...
const trial7 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">OAK</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "OAK"},
...
const trial6 = {
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "INCOME"},
...
const trial4 = {
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "MESSAGE"},
...
const trial2 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">CHOCOLATE</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "CHOCOLATE"},
...
const trial1 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">FOOTBALL</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "FOOTBALL"},
