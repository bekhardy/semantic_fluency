...
const trial8 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">JEWELRY</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "JEWELRY"},
...
const trial6 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">BONNET</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "BONNET"},
...
const trial5 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">LINEN</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "LINEN"},
...
const trial3 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">COLOR</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "COLOR"},
...
const trial1 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">SECRETARY</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "SECRETARY"},
