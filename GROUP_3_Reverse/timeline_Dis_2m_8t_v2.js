...
const trial8 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">TROUBLE</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "TROUBLE"},
...
const trial7 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">KITCHEN</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "KITCHEN"},
...
const trial6 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">EFFORT</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "EFFORT"},
...
const trial5 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">FAMILY</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "FAMILY"},
...
const trial4 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">CHILD</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "CHILD"},
...
const trial3 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">HERB</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "HERB"},
...
const trial2 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">LECTURE</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "LECTURE"},
...
const trial1 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">DOLLAR</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "DOLLAR"},
