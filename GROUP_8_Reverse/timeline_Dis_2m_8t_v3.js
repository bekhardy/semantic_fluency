...
const trial8 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">EDITORIAL</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "EDITORIAL"},
...
const trial7 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">WRITER</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "WRITER"},
...
const trial6 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">SOAP</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "SOAP"},
...
const trial5 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">CONFLICT</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "CONFLICT"},
...
const trial4 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">WELFARE</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "WELFARE"},
...
const trial3 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">BRUISE</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "BRUISE"},
...
const trial2 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">PERFORMER</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "PERFORMER"},
...
const trial1 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">SMOKE</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "SMOKE"},
