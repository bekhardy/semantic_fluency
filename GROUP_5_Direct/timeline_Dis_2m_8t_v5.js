...
const trial7 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">DRESS</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "DRESS"},
...
const trial6 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">ORGAN</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "ORGAN"},
...
const trial5 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">LAPTOP</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "LAPTOP"},
...
const trial4 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">SCENT</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "SCENT"},
...
const trial3 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">TOAST</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "TOAST"},
...
const trial2 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">DISEASE</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "DISEASE"},
...
const trial1 = {
  ...
  stimulus: `
   ...
   <p> Please type as many different words related to:</p>
      ...
      <div style="
          ...
          padding-top:0px;
      ">
        <h2 style="margin-bottom:10px;">STUDENT</h2>
        <p>Type a word and press Enter:</p>
        <input 
          type="text" 
          id="wordInput" 
  ...
  `,
  choices: "NO_KEYS",
  data: { task: "verbal_fluency", cue_word: "STUDENT"},
